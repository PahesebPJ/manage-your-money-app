...
import { getIncomeSources, addIncomeSource, deleteIncomeSource } from '../storage/storage';
        ...
        <SafeAreaView style={styles.safe}>
            ...
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.subtitle}>{items.length} fuente{items.length !== 1 ? 's' : ''} de ingreso</Text>
                </View>
            ...
            <FlatList
                ...
                renderItem={({ item, index }) => (
                    <IncomeItemCard item={item} onDelete={handleDelete} index={index} />
                )}
                ListEmptyComponent={
                    <View style={styles.empty}>
                        <Text style={styles.emptyEmoji}>💰</Text>
                        <Text style={styles.emptyTitle}>Sin ingresos</Text>
                        <Text style={styles.emptyText}>Presiona el botón + para agregar tu primera fuente de ingreso.</Text>
                    </View>
                }
            />
